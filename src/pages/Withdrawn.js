                        ...
                        <div class="widget widget-account-invoice-three">
                            ...
                            <div class="widget-heading">
                                ...
                                <div class="wallet-balance">
                                    <p class="balanceWallet" style={{"fontSize": "2.5rem"}}>NFT <br></br>Balance</p>
                                    <h1 class="balance"><span class="w-currency"  style={{"fontSize": "2.5rem"}}>$</span>2953</h1>
                                </div>
                            </div>
                                ...
                                <div class="invoice-list">
                                    ...
                                    <div class="inv-detail">
                                        <div class="info-detail-1">
                                            <p style={{"fontSize": "20px"}}>Total Withdrawn</p>
                                            <p><span class="w-currency" style={{"fontSize": "20px"}}>$</span> <span class="bill-amount" style={{"fontSize": "37px"}}>2000</span></p>
                                        </div>
                                        <div class="info-detail-1">
                                            <p style={{"fontSize": "20px"}}>Total NFT Burned</p>
                                            <p><span class="bill-amount" style={{"fontSize": "37px"}}>8</span></p>
                                        </div>
                                        <div class="info-detail-2" style={{"marginTop": "30px"}}>
                                            <ul class="navbar-item flex-row ml-md-auto" style={{"display": "flex"}}>
                                                <button style={{"margin": "5px", "width": "200px", "height": "50px" , "border-radius": "30px",  "background": "linear-gradient(to bottom left,#0098f0,#005792)",  "fontSize":" 20px",  "color": "white", "border": "none", "letterSpacing": "1px"}}>Withdraw</button>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
